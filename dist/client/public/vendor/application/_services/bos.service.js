...
var BosService = /** @class */ (function () {
    function BosService(_http) {
        this._http = _http;
    }
    BosService.prototype.consult = function (event, consultationDate, programmeCode) {
    ...
    BosService = __decorate([
        core_1.Injectable()
    ], BosService);
    return BosService;
}());
exports.BosService = BosService;
